...
---
= Digital Advisor 의 지속가능성 대시보드 기능에 대해 알아보세요.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
*탄소 저감률*: 각 지역/도시별 탄소 저감률을 백분율로 표시하며, 제시된 기준값은 사용자의 위치를 기준으로 합니다. 백분율 값 옆에 있는 image:edit_icon_1.png["편집 가능한 아이콘이 표시된 스크린샷"] 아이콘을 선택하여 특정 지역의 탄소 저감률을 조정할 수 있으며, 탄소 수치는 자동으로 그에 따라 조정됩니다.

...
* *AutoSupport 도입 현황*: AutoSupport가 활성화된 시스템의 수와 비율을 표시합니다. '거부됨'으로 표시된 시스템, *HTTPS* 및 *AutoSupport on Demand*가 활성화된 시스템, 그리고 지난 7일 동안 AutoSupport 데이터 전송이 중단된 시스템의 *신호 끊김*도 확인할 수 있습니다. 시스템 상태 점검 점수 및 설치 기반의 시스템에 대한 정보를 보려면 *AutoSupport 도입 현황* 위젯을 클릭하십시오.

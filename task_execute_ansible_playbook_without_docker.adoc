...
---
= NetApp Docker 이미지 없이 Ansible 플레이북을 실행하세요
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
----
+
ansible-galaxy 명령에 대한 자세한 내용은 link:https://docs.ansible.com/projects/ansible/latest/cli/ansible-galaxy.html["Ansible Galaxy 문서"^]을 참조하고, NetApp Ansible Collection에 대한 자세한 내용은 link:https://galaxy.ansible.com/netapp/ontap["NetApp Ansible 컬렉션 페이지"^]을 참조하십시오.

...
---
= Digital Advisor 에서 구성 변경 템플릿을 관리하세요
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
.단계
. 왼쪽 창에서 *구성 드리프트*를 선택합니다.
. image:clone_icon.png["복제"]을 선택하여 템플릿의 사본을 만드십시오.
. image:share_icon.png["공유"]을 선택하고 템플릿을 공유할 사용자의 사용자 이름을 입력합니다.
+

NOTE: 사용자 이름 대신 사용자의 이메일 주소를 입력하면 템플릿이 공유되지 않습니다.

. image:edit_icon.png["편집"]을 선택하여 템플릿의 세부 정보를 업데이트합니다.
. image:delete_icon.png["삭제"]을 선택하여 템플릿을 삭제합니다.

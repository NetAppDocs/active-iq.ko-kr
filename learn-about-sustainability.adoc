...
---
= Digital Advisor 와 함께 지속가능성에 대해 알아보세요.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
지속가능성 대시보드에서 지속가능성 점수, 예상 전력 사용량, 직접 탄소 배출량 및 열을 확인할 수 있습니다. 특정 사이트에 대한 탄소 저감 비율을 조정할 수 있습니다. 클러스터 수준의 지속가능성 점수도 확인할 수 있습니다. 지속가능성 점수를 기반으로 지속가능성 현황을 평가하고 NetApp에서 권장하는 조치를 실행하여 점수를 개선할 수 있습니다. 지속가능성 대시보드에 대한 자세한 내용은 link:sustainability-dashboard-overview.html["Sustainability 대시보드 개요"]을 참조하십시오.

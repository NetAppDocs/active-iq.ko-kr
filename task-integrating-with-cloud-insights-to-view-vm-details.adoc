...
---
= Digital Advisor 사용하여 Data Infrastructure Insights 에서 사용할 수 있는 가상 머신 데이터를 확인하세요.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
.단계
. *인벤토리* 위젯에서 *가상 머신*을 선택하면 Data Infrastructure Insights에서 사용 가능한 데이터를 볼 수 있습니다.
. *가상 머신 개요* 탭을 선택하십시오.
. *ESX 호스트 수*를 선택하여 호스트에 대한 정보를 확인하십시오.
. 자세한 정보를 보려면 *ESX Name* 을 선택하여 Data Infrastructure Insights 로 이동하십시오.

...
* AutoSupport (ASUP)가 올바르게 활성화되고 구성되었으며, 모든 필수 섹션이 포함되어 있는지 확인하세요. 자세한 내용은 다음을 참조하세요. link:hhttps://kb.netapp.com/on-prem/ontap/Ontap_OS/OS-KBs/ONTAP_AutoSupport_Resolution_Guide["ONTAP AutoSupport 해결 가이드"].
